...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        <div class="container">
            ...
            <!-- Image Logo -->
            <a class="navbar-brand logo-image" href="index.php">V-N-T
			<style>
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                ...
                <span class="nav-item">
                    <a class="btn-outline-sm" href="http://localhost/PROJET_WEB_Yassine_Sahar/Login.php">LOG IN</a>
                </span>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-xl-5">
                        <div class="text-container">
                            <h1>The best customer service experiences  </h1>
                            <p class="p-large">Connecting with consumers is the key to growing your brand, and outsourced customer service through SAS lets you help your customers 24/7/365.</p>
                            <a class="btn-solid-lg page-scroll" href="http://localhost/PROJET_WEB_Yassine_Sahar/Register.php">SIGN UP</a>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <a class="btn-solid-reg mfp-close" href="http://localhost/PROJET_WEB_Yassine_Sahar/Register.php">SIGN UP</a> <a class="btn-outline-reg mfp-close as-button" href="#screenshots">BACK</a>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="text-container">
                        ...
                        <a class="btn-solid-reg page-scroll" href="http://localhost/PROJET_WEB_Yassine_Sahar/Register.php">SIGN UP</a>
                    </div> <!-- end of text-container -->
                </div> <!-- end of col -->
                <div class="col-lg-6">
                    <div class="image-container">
                    ...
                    <div class="footer-col last">
                        ...
                        <ul class="list-unstyled li-space-lg p-small">
                            ...
                            <li class="media">
                                ...
                                <div class="media-body"><a class="white" href="#">contact@VNT.com</a> <i class="fas fa-globe"></i><a class="white" href="#your-link">www.vnt.com</a></div>
                            </li>
                        </ul>
                    </div> 
                </div> <!-- end of col -->
    ...
    <div class="copyright">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <p class="p-small">Copyright © 2021 <a href="#">Yassine & Sahar</a></p>
                </div> <!-- end of col -->
            </div> <!-- enf of row -->
        </div> <!-- end of container -->
